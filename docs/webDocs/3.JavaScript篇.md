...
## 18. JavaScript 中如何进行隐式类型转换？--了解即可
...
## 28. 实现 call、apply 及 bind 函数（建议看一下鲨鱼哥的掘金手写）
